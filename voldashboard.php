...
<head>
  <meta charset="UTF-8">
  <title>Find Your Volunteer Match - Connect with Opportunities</title>
...
<body>
  <main>
    <nav class="main-menu">
      <h1 class="logoname">UnityHands</h1>
      <img class="logo" src="https://openclipart.org/image/800px/303371" alt="Logo" />
      <ul>
        ...
        <li class="nav-item">
          <a href="#">
            ...
            <span class="nav-text">Community Highlights</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="#">
            <i class="fa fa-sliders nav-icon"></i>
            <span class="nav-text">Find Opportunities</span>
          </a>
        </li>
      </ul>
    </nav>
    ...
    <section class="content">
      <div class="left-content">
        <div class="activities">
          ...
          <div class="activity-container">
            <div class="image-container img-one">
              <img
                src="https://images.squarespace-cdn.com/content/v1/572b597a1bbee0f4e8d01e5e/1699283312640-358FLNN82R6696EF5GPX/STAR+-+Group+photos-29.JPG"
                alt="Animal-Rescue" />
              <div class="overlay">
                <h3>Animal Rescue</h3>
              </div>
            ...
            <div class="image-container img-two">
              <img
                src="https://www.volunteerforever.com/wp-content/uploads/2019/01/Medical-Volunteer-Abroad-Section-Header.jpg"
                alt="Healthcare" />
              <div class="overlay">
                <h3>Healthcare</h3>
              </div>
            ...
            <div class="image-container img-four">
              <img src="https://www.ymca.org/sites/default/files/2021-04/0022355.jpg" alt="children" />
              <div class="overlay">
            ...
            <div class="image-container img-five">
              <img src="https://www.worldendeavors.com/wp-content/uploads/2023/07/Construction-featured10.jpg"
                alt="community" />
              <div class="overlay">
                <h3>Community</h3>
              </div>
            ...
            <div class="image-container img-six">
              <img
                src="https://www.signupgenius.com/cms/socialMediaImages/beach-clean-up-tips-ideas-facebook-1200x630.png"
                alt="environment" />
              <div class="overlay">
                <h3>Environmental</h3>
              </div>
        ...
        <div class="left-bottom">
          <div class="weekly-schedule">
            <h1>Recruiting Organizations</h1>
            <div class="calendar">
      ...
      <div class="right-content">
        ...
        <div class="volunteer-hours">
          <h1 style="align-self: flex-start">My Volunteer Hours in 2025</h1>
          <div class="volunteer-hours-container">
            <div class="box" style="--i: 85%">
              <div class="circle">
                <h2>0<small>hrs</small></h2>
              </div>
              <p>Total Hours Volunteered</p>
            </div>
            <div class="hours-content">
              <p><span>This Week:</span> 0 hr</p>
              <p><span>This Month:</span> 0 hrs</p>
              <p><span>This Year:</span> 0 hrs</p>
            </div>
          </div>
        </div>
        

        <div class="mobile-personal-impact">
          <h1>My Volunteer Impact</h1>
          <div class="personal-impact-container">
            <div class="best-item box-one">
              <p>Charity Run: 10km</p>
          ...
          <div class="card-container">
            <div class="card">
              ...
              <img class="card-img"
                ...
                alt="" />
              <p>Organized a local blood donation drive, collecting over 65 pints of blood to support the community. 🎉</p>
            </div> 
             ...
             <div class="card card-two">
              <div class="card-user-info">
                <img
                  ...
                  alt="" />
                <h2>Riya's Journey</h2>
              </div>
              <img class="card-img"
                src="library.jpg"
                alt="" />
              <p>Volunteered 100 hours at the city library, helping to set up a children's reading program.💪</p>
            </div>
          </div>
        </div>
      </div>
...
<!-- https://github.com/ecemgo/mini-samples-great-tricks/assets/13468728/bef54506-ea45-4e42-a1b6-23a48f61c5e8 -->
<!-- https://github.com/ecemgo/mini-samples-great-tricks/assets/13468728/2dcc1b94-06c5-4c62-b886-53b9e433fd44 -->